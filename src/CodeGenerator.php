...
class CodeGenerator
{
    ...
    public static function createModel($config, $comm = null)
    {
        ...
        \Iseed::generateSeed('modules');
        \Iseed::generateSeed('module_fields');
        \Iseed::generateSeed('la_menus');
        \Iseed::generateSeed('role_module');
        \Iseed::generateSeed('role_module_fields');
    }
