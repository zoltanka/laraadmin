...
@section('main-content')
    <div id="page-content" class="profile2">
        <div class="@if(isset($module->is_gen) && $module->is_gen) bg-success @else bg-danger @endif clearfix">
            <div class="col-md-4">
                <div class="row">
                    <div class="col-md-3">
        ...
        <ul id="module-tabs" data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
            ...
            <li class="tab-pane" id="filter">
                <a id="tab_filter" role="tab" data-toggle="tab" class="tab_info " href="#filter"
                   data-target="#tab-filter"><i class="fa fa-filter"></i> Filtering</a>
            </li>
        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane fade in p20 bg-white" id="tab-filter">
                <form action="{{ url(config('laraadmin.adminRoute') . '/save_module_field_filter/'.$module->id) }}"
                      method="post">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <table class="table table-condensed table-hover">
                                ...
                                <tr>
                                    <th>Field name</th>
                                    <th>Selected filtering option</th>
                                </tr>
                                </thead>
                                <tbody>
                                @foreach ($module->fields as $field)
                                        ...
                                        <td>
                                            <select name="filter[{{$field['id']}}]">
                                                ...
                                                @foreach ($filterTypes as $key => $filter)
                                                    <option value="{{ $key }}"
                                                            @if ($key == $field['filter']) selected @endif>{{ $filter }}</option>
                                                @endforeach
                                            </select>
                                        </td>
                                    </tr>
